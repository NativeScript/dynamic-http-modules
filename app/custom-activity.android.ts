...
@NativeClass()
@JavaProxy('org.nativescript.dynamichttpmodules.CustomActivity')
class CustomActivity extends androidx.appcompat.app.AppCompatActivity {
  ...
  public onCreate(savedInstanceState: android.os.Bundle): void {
    ...
    console.log('onCreate called in CustomActivity!')
  ...
  public onNewIntent(intent: android.content.Intent): void {
    console.log('onNewIntent called in CustomActivity!')
  ...
  public onStart(): void {
    console.log('onStart called in CustomActivity!')
